...
<head>
    ...
    <title>Admin Panel - Guides</title>
    <style>
        body {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    $sql = "INSERT INTO guides (name, occupation, tours, experience, rating, contact, imageURL) VALUES ('$name', '$occupation', '$tours', '$experience', '$rating', '$contact', '$imageURL')";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_product'])) {
    ...
    if (isset($_POST['selected_product'])) {
        ...
        $sql = "DELETE FROM guides WHERE id = '$selected_product'";
...
<form action="" method="post">
    ...
    <input type="number" name="tours" required><br>
    ...
    <input type="email" name="contact" required><br>
