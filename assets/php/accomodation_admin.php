...
<head>
    ...
    <title>Admin Panel - Accomodaions</title>
    <style>
        body {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    $sql = "INSERT INTO hotels (name, rating, description, price, imageURL, link) VALUES ('$name', '$rating', '$description', '$price', '$imageURL', '$link')";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_product'])) {
    ...
    if (isset($_POST['selected_product'])) {
        ...
        $sql = "DELETE FROM hotels WHERE id = '$selected_product'";
