...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    $sql = "INSERT INTO blog (name, author, date, time, occupation, link, imageURL) VALUES ('$name', '$author', '$date', '$time', '$occupation', '$link', '$imageURL')";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_product'])) {
    ...
    if (isset($_POST['selected_product'])) {
        ...
        $sql = "DELETE FROM blog WHERE id = '$selected_product'";
...
<form action="" method="post">
    ...
    <label for="occupation">Author Occupation:</label>
