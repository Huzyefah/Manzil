...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    $sql = "INSERT INTO activities (name, description, location, link, imageURL, date) VALUES ('$name', '$description', '$location', '$link', '$imageURL', '$date')";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_product'])) {
    ...
    if (isset($_POST['selected_product'])) {
        ...
        $sql = "DELETE FROM activities WHERE id = '$selected_product'";
