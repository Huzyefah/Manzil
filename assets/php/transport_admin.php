...
<head>
    ...
    <title>Admin Panel - Transport</title>
    <style>
        body {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    $sql = "INSERT INTO transport (name, price, imageURL) VALUES ('$name', '$price', '$imageURL')";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_product'])) {
    ...
    if (isset($_POST['selected_product'])) {
        ...
        $sql = "DELETE FROM transport WHERE id = '$selected_product'";
