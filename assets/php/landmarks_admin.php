...
<head>
    ...
    <title>Admin Panel - Landmarks</title>
    <style>
        body {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    $sql = "INSERT INTO landmarks (name, description, link, imageURL) VALUES ('$name', '$description', '$link', '$imageURL')";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_product'])) {
    ...
    if (isset($_POST['selected_product'])) {
        ...
        $sql = "DELETE FROM landmarks WHERE id = '$selected_product'";
...
$result = $conn->query("SELECT * FROM landmarks");
